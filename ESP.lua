--[[
	...
	Universal ESP Module by Aegians © CC0 1.0 Universal (2023)
...
getgenv().AegiansDeveloperESP = {
	DeveloperSettings = {
		Path = "Christian Developer/Aegians ESP/Configuration.cfg",
...
local Environment = getgenv().AegiansDeveloperESP
...
Environment.Exit = function(self) -- METHOD | (<void>) => <void>
	...
	if self:UnwrapAll() then
		...
		for Index, _ in next, Environment do
			getgenv().AegiansDeveloperESP[Index] = nil
		end

		LoadESP = nil; Recursive = nil; Loaded = false

		getgenv().AegiansDeveloperESP = nil
	end
end
...
Environment.UpdateConfiguration = function(DeveloperSettings, Settings, Properties) -- (<table> DeveloperSettings, <table> Settings, <table> Properties) => <table> New Environment
	...
	getgenv().AegiansDeveloperESP.Properties = Properties

	Environment = getgenv().AegiansDeveloperESP
